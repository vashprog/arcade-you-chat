...
import { Phone, PhoneOff, Link2 } from 'lucide-react';

interface IncomingWordChainModalProps {
  hostName: string;
  onAccept: () => void;
  onReject: () => void;
}

const IncomingWordChainModal = ({ hostName, onAccept, onReject }: IncomingWordChainModalProps) => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm animate-fade-in">
      <div className="relative bg-card border border-border rounded-2xl p-8 shadow-2xl max-w-sm mx-4 animate-scale-in">
        ...
        <div className="relative text-center">
          ...
          {/* Game info */}
          <h2 className="font-display text-xl mb-1 text-foreground">Word Chain! 🔗</h2>
...
export default IncomingWordChainModal;
